        ...
        >
          ...
          <button
            ...
            style={{
              width: '100%',
              padding: '8px 0',
              background: tradeDisabledReason ? '#222a37' : '#0ea5e9',
              color: tradeDisabledReason ? '#7f8a9c' : '#ecfeff',
              border: tradeDisabledReason ? '1px solid #374151' : '1px solid #0284c7',
              borderRadius: 6,
              fontSize: 13,
          ...
          <button
            ...
            style={{
              width: '100%',
              padding: '8px 0',
              background: canEndTurn ? '#f59e0b' : '#222a37',
              color: canEndTurn ? '#1c1917' : '#7f8a9c',
              border: canEndTurn ? '1px solid #d97706' : '1px solid #374151',
              borderRadius: 6,
              fontSize: 13,
